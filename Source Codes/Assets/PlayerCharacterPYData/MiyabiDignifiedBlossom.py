...
# Sword Sheath
'e3590e91': [(log, ('2.8: MiyabiDignifiedBlossom SwordSheath draw_vb Hash',)),       (add_section_if_missing, ('562b2030', 'MiyabiDignifiedBlossom.Miyabi.IB', 'match_priority = 0\n'))],
'fc93f762': [(log, ('2.8: MiyabiDignifiedBlossom SwordSheath position_vb Hash',)),   (add_section_if_missing, ('562b2030', 'MiyabiDignifiedBlossom.Miyabi.IB', 'match_priority = 0\n'))],
'a9ac3439': [(log, ('2.8: MiyabiDignifiedBlossom SwordSheath texcoord_vb Hash',)),   (add_section_if_missing, ('562b2030', 'MiyabiDignifiedBlossom.Miyabi.IB', 'match_priority = 0\n'))],
'38c91cb1': [(log, ('2.8: MiyabiDignifiedBlossom SwordSheath blend_vb Hash',)),      (add_section_if_missing, ('562b2030', 'MiyabiDignifiedBlossom.Miyabi.IB', 'match_priority = 0\n'))],

# Sword Handle
'5e1e12aa': [(log, ('2.8: MiyabiDignifiedBlossom SwordHandle draw_vb Hash',)),       (add_section_if_missing, ('1a82a439', 'MiyabiDignifiedBlossom.Miyabi.IB', 'match_priority = 0\n'))],
'10545b04': [(log, ('2.8: MiyabiDignifiedBlossom SwordHandle position_vb Hash',)),   (add_section_if_missing, ('1a82a439', 'MiyabiDignifiedBlossom.Miyabi.IB', 'match_priority = 0\n'))],
'51af1803': [(log, ('2.8: MiyabiDignifiedBlossom SwordHandle texcoord_vb Hash',)),   (add_section_if_missing, ('1a82a439', 'MiyabiDignifiedBlossom.Miyabi.IB', 'match_priority = 0\n'))],
'c55927b0': [(log, ('2.8: MiyabiDignifiedBlossom SwordHandle blend_vb Hash',)),      (add_section_if_missing, ('1a82a439', 'MiyabiDignifiedBlossom.Miyabi.IB', 'match_priority = 0\n'))],
...
'e1215530': [
        ...
        (add_section_if_missing,        ('562b2030', 'MiyabiDignifiedBlossom.Miyabi.IB', 'match_priority = 0\n')),
        (add_section_if_missing,        ('1a82a439', 'MiyabiDignifiedBlossom.Miyabi.IB', 'match_priority = 0\n')),
    ],
'f9ec3ac8': [
