...
# Historical hashes (2.2-2.7): weapon cockpit & weapon NormalMap lama
'56979e94': [
        (log,                           ('2.2: Seed weapon VB Hash',)),
        (update_hash,                   ('030e0aca',)),
    ],
'b095c5cf': [
        (log,                           ('2.2: Seed weapon VB Hash',)),
        (update_hash,                   ('567f9bcd',)),
    ],
'fc59be11': [
        (log,                           ('2.2: Seed weapon NormalMap 2048p Hash',)),
        (update_hash,                   ('b35534a9',)),
    ],
'b87d9c50': [
        (log,                           ('2.2-2.3: Seed weapon NormalMap 1024p Hash',)),
    ],
'b35534a9': [
        (log,                           ('2.3-2.7: Seed weapon NormalMap 2048p Hash',)),
        (update_hash,                   ('b87d9c50',)),
    ],
    }
