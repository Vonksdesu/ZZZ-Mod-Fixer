    ...
    def save(self):
        if self._touched:
            ...
            try:
                ...
                print(f"⚠️  Gagal membuat folder backup luar di '{backup_dir}': {e}")
                backup_dir = os.path.abspath(self.filepath.split(basename+'.ini')[0])
            ...
            try:
                ...
                print(f"⚠️  Gagal merelokasi backup ke luar (Beda Drive/Akses): {e}")
                ...
                try:
                    ...
                    print(f"❌ Gagal membuat cadangan darurat: {ex}")
